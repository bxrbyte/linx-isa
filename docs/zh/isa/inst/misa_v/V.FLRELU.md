...
![V.FLRELU](../../../figs/bitfield/svg/Instruction_64bit/V.FLRELU.svg)
...
for (laneid = 0; laneid < lanenum; laneid++)
{
    ...
    if (pmask[laneid] == 1) {
        bits(srcWidth) operand1 = V[m, srcWidth, laneid];
        bits(srcWidth) operand2 = V[n, srcWidth, laneid];
        bits(dstwidth) result = (operand1 >= 0.0) ? operand1 : (operand1 * operand2);
